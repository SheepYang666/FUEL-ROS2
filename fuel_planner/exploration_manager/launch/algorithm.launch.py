...
def generate_launch_description():
    declared_arguments = [
        ...
        DeclareLaunchArgument("box_min_x"),
        DeclareLaunchArgument("box_min_y"),
        DeclareLaunchArgument("box_min_z"),
        DeclareLaunchArgument("box_max_x"),
        DeclareLaunchArgument("box_max_y"),
        DeclareLaunchArgument("box_max_z"),
    ...
    params = {
        ...
        "exploration.yd": 60.0 * pi / 180.0,
        "exploration.ydd": 90.0 * pi / 180.0,
        "exploration.w_dir": 1.5,
        "exploration.tsp_dir": PathJoinSubstitution([FindPackageShare("lkh_tsp_solver"), "resource"]),
        ...
        "frontier.candidate_dphi": 15.0 * pi / 180.0,
    ...
    return LaunchDescription(declared_arguments + [exploration_node])
